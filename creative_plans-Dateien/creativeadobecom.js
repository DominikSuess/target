...
function s_doPlugins(s) {
    if (s.server == 'creative.adobe.com') {
        ...
        if (s.eVar67) s.eVar67 = s.eVar67.replace(/:$/, "");
        ...
        if (typeof(s.eVar15) !== "undefined" && s.eVar15.indexOf("@Adobe") != -1) {
            ...
            dclkFrame.src = 'https://fls.doubleclick.net/activityi;src=1295336;type=store031;cat=nacre451;u5=' + s.eVar15 + ';ord=1;num=' + dclkFrame_a + '?';
            document.body.appendChild(dclkFrame);
        }

        if (typeof(s.pageName) !== "undefined" && s.pageName.indexOf("Photography_Page") != -1) {
            dclkFrame = document.createElement('iframe');
            dclkFrame.style.display = "none";
            dclkFrame.style.width = "1";
            dclkFrame.style.height = "1";
            //if (s.prop32=='cc_en-us' || s.prop32=='cc_en') {
            dclkFrame.src = 'https://1295336.fls.doubleclick.net/activityi;src=1295336;type=cs;cat=Howto0;ord=1;num=' + dclkFrame_a + '?';
            document.body.appendChild(dclkFrame);
            //}
        }
        ...
        /*else if (typeof(s.pageName) !== "undefined" && s.pageName.indexOf("PaymentInfo_Page") != -1) {
                    if (typeof(s.countryCode) !== "undefined" && typeof(s.currencyCode) !== "undefined") {
                        if (s.countryCode == "DE" || s.countryCode == "FR" || s.countryCode == "AT")
                            s.currencyCode = "EUR";
                        else if (s.countryCode == "SE") s.currencyCode = "SEK";
                        else if (s.countryCode == "NO") s.currencyCode = "NOK";
                        else if (s.countryCode == "DK") s.currencyCode = "DKK";
                        else if (s.countryCode == "CH") s.currencyCode = "CHF";
                        else if (s.countryCode == "AU" || s.countryCode == "NZ") s.currencyCode = "AUD";
                        else if (s.countryCode == "GB") s.currencyCode = "GBP";
                        else if (s.countryCode == "JP") s.currencyCode = "JPY";
                        else s.currencyCode = "USD";
                    }*/
        else if (typeof(s.pageName) !== "undefined" && s.events == 'purchase' && s.purchaseID) {

            if (s.purchaseID.indexOf("AU") != -1 || s.purchaseID.indexOf("NZ") != -1) {
                s.currencyCode = "AUD";
            } else if (s.purchaseID.indexOf("DE") != -1 || s.purchaseID.indexOf("FR") != -1 || s.purchaseID.indexOf("AT") != -1 || s.purchaseID.indexOf("IT") != -1 || s.purchaseID.indexOf("ES") != -1 || s.purchaseID.indexOf("FI") != -1 || s.purchaseID.indexOf("IE") != -1 || s.purchaseID.indexOf("PL") != -1 || s.purchaseID.indexOf("PT") != -1 || s.purchaseID.indexOf("HU") != -1 || s.purchaseID.indexOf("RO") != -1 || s.purchaseID.indexOf("NL") != -1 || s.purchaseID.indexOf("BE") != -1 || s.purchaseID.indexOf("CZ") != -1 || s.purchaseID.indexOf("EEUROPE") != -1 || s.purchaseID.indexOf("BG") != -1 || s.purchaseID.indexOf("EE") != -1 || s.purchaseID.indexOf("LV") != -1 || s.purchaseID.indexOf("LT") != -1 || s.purchaseID.indexOf("SK") != -1 || s.purchaseID.indexOf("SI") != -1 || s.purchaseID.indexOf("EDSE") != -1 || s.purchaseID.indexOf("EDNO") != -1 || s.purchaseID.indexOf("EDDK") != -1 || s.purchaseID.indexOf("EDCH") != -1 || s.purchaseID.indexOf("LU") != -1) {
                s.currencyCode = "EUR";
            } else if (s.purchaseID.indexOf("SE") != -1) {
                s.currencyCode = "SEK";
            } else if (s.purchaseID.indexOf("NO") != -1) {
                s.currencyCode = "NOK";
            } else if (s.purchaseID.indexOf("DK") != -1) {
                s.currencyCode = "DKK";
            } else if (s.purchaseID.indexOf("CH") != -1) {
                s.currencyCode = "CHF";
            } else if (s.purchaseID.indexOf("UK") != -1) {
                s.currencyCode = "GBP";
            } else if (s.purchaseID.indexOf("JP") != -1) {
                s.currencyCode = "JPY";
            } else s.currencyCode = "USD";

            if (typeof(s.countryCode) == "undefined" && typeof(s.currencyCode) == "undefined" && Adobe && Adobe.CheckoutAnyware && Adobe.CheckoutAnyware.ConfigModel && typeof(Adobe.CheckoutAnyware.ConfigModel.country) !== "undefined") {
        ...
        /*
         if(typeof(s.currencyCode)!=="undefined"){
          s.currencyCode=s.getAndPersistValue(s.currencyCode,'s_cp_cc');
          s.currencyCode=s.getAndPersistValue(s.currencyCode,'s_cp_ccmplantype');
         }
           if(typeof(s.currencyCode)=="undefined"){ 
        ...
        */
        ...
        if (s.pageName !== "undefined" && s.events == 'purchase' && s.purchaseID != '') {
            ...
            if (typeof(s.currencyCode) == "undefined" && s.contextData['sc.currency'] != '') s.currencyCode = s.contextData['sc.currency'];

            /*
    if(typeof(s.currencyCode)=="undefined" && s.contextData['sc.currency']!='') {
        s.currencyCode=s.contextData['sc.currency'];
    }
    else s.currencyCode = 'USD';
    */
            ...
            if (s.pageName.indexOf("Edu_Join_ConfirmOrder") != -1) {
                if (typeof(s.countryCode) !== "undefined") {
                    if ((s.currencyCode == 'EUR' || s.currencyCode == 'SEK' || s.currencyCode == 'CHF' || s.currencyCode == 'GBP') || (s.purchaseID.indexOf("NL") != -1 && s.prop32 == "cc_nl")) scSubCat = 'edustore';
                    else if (s.currencyCode == 'AUD' && (s.countryCode == "AU" || s.countryCode == "NZ")) scSubCat = 'educa938'
                    else if (s.currencyCode.indexOf('USD') != -1) scSubCat = 'naedu511';
                    else scSubCat = 'non-n324';
                    s.events = "purchase,event54";
                }
                if (typeof(s.countryCode) == "undefined") {
                    if ((s.currencyCode == 'EUR' || s.currencyCode == 'SEK' || s.currencyCode == 'CHF' || s.currencyCode == 'GBP') || (s.purchaseID.indexOf("NL") != -1 && s.prop32 == "cc_nl")) scSubCat = 'edustore';
                    else if (s.currencyCode == 'AUD') scSubCat = 'educa938';
                    else if (s.currencyCode.indexOf('USD') != -1) scSubCat = 'naedu511';
                    else scSubCat = 'non-n324';
                    s.events = "purchase,event54";
                }
                ...
                if (typeof(s.countryCode) !== "undefined") {
                    if ((s.currencyCode == 'EUR' || s.currencyCode == 'SEK' || s.currencyCode == 'CHF' || s.currencyCode == 'GBP') || (s.purchaseID.indexOf("NL") != -1 && s.prop32 == "cc_nl")) scSubCat = 'ccmstore';
                    else if (s.currencyCode == 'AUD' && s.countryCode == "AU") scSubCat = 'austr666';
                    else if (s.currencyCode.indexOf('JPY') != -1) scSubCat = 'japan172';
                    else if (s.currencyCode == 'AUD' && s.countryCode == "NZ") scSubCat = 'newze094';
                    else if (s.currencyCode.indexOf('USD') != -1) scSubCat = 'nacre015';
                    else scSubCat = 'creat970';
                }
                if (typeof(s.countryCode) == "undefined") {
                    if ((s.currencyCode == 'EUR' || s.currencyCode == 'SEK' || s.currencyCode == 'CHF' || s.currencyCode == 'GBP') || (s.purchaseID.indexOf("NL") != -1 && s.prop32 == "cc_nl")) scSubCat = 'ccmstore';
                    else if (s.purchaseID.indexOf("NZ") != -1 && s.currencyCode == 'AUD') scSubCat = 'newze094';
                    else if (s.currencyCode == 'AUD') scSubCat = 'austr666';
                    else if (s.currencyCode.indexOf('JPY') != -1) scSubCat = 'japan172';
                    else if (s.currencyCode.indexOf('USD') != -1) scSubCat = 'nacre015';
                    else scSubCat = 'creat970';
                }
            ...
            if (s.products.indexOf("CreativeCloud_Promo") != -1) {
                ...
                if ((s.currencyCode == 'EUR' || s.currencyCode == 'SEK' || s.currencyCode == 'CHF' || s.currencyCode == 'GBP') || (s.purchaseID.indexOf("NL") != -1 && s.prop32 == "cc_nl")) scSubCat = 'ccmteam';
            ...
            if (scProd.length == 6) {
                ...
                dclkFrame3 = document.createElement('iframe');
                dclkFrame3.style.display = "none";
                dclkFrame3.style.width = "1";
                dclkFrame3.style.height = "1";
                dclkFrame4 = document.createElement('iframe');
                dclkFrame4.style.display = "none";
                dclkFrame4.style.width = "1";
                dclkFrame4.style.height = "1";


                if (scSubCat == 'austr666') {
                    dclkFrame.src = 'https://1295336.fls.doubleclick.net/activityi;src=1295336;type=store031;cat=austr666' + ';qty=' + scProd[2] + ';cost=' + scProd[3] + ';u7=' + scSKUName + ';u6=' + s.currencyCode + ';u1=1;u2=' + scProdName + ';ord=' + s.purchaseID + '?';
                    document.body.appendChild(dclkFrame);
                }

                if (scSubCat == 'newze094') {
                    dclkFrame.src = 'https://1295336.fls.doubleclick.net/activityi;src=1295336;type=store031;cat=newze094' + ';qty=' + scProd[2] + ';cost=' + scProd[3] + ';u7=' + scSKUName + ';u6=' + s.currencyCode + ';u1=1;u2=' + scProdName + ';ord=' + s.purchaseID + '?';
                    document.body.appendChild(dclkFrame);
                }
                if (s.pageName.indexOf("Join_ConfirmOrder_OrderCompleted") !== -1) {
                    var joinResult = s.pageName.split("_");
                    if (joinResult[2] === "Join" || joinResult[2] === "SpecialOffer") {
                        dclkFrame4.src = 'https://1295336.fls.doubleclick.net/activityi;src=1295336;type=store031;cat=NACCI0' + ';qty=' + scProd[2] + ';cost=' + scProd[3] + ';u7=' + scSKUName + ';u6=' + s.currencyCode + ';u1=1;u2=' + scProdName + ';ord=' + s.purchaseID + '?';
                        document.body.appendChild(dclkFrame4);
                    }
                }

                if (scSubCat == 'ccmstore') {
                    if (typeof(s.countryCode) !== "undefined") {
                        dclkFrame.src = 'https://fls.doubleclick.net/activityi;src=4167672;type=cc_store;cat=' + scSubCat + ';qty=' + scProd[2] + ';cost=' + scProd[3] + ';u6=' + scSKUName + ';u5=' + s.currencyCode + ';u1=1;u2=' + scProdName + ';u7=' + s.countryCode + ';u20=250713;ord=' + s.purchaseID + '?';
                        document.body.appendChild(dclkFrame);

                        dclkFrame2.src = 'https://1295336.fls.doubleclick.net/activityi;src=1295336;type=store031;cat=adobe992' + ';qty=' + scProd[2] + ';cost=' + scProd[3] + ';u7=' + scSKUName + ';u6=' + s.currencyCode + ';u1=1;u2=' + scProdName + ';ord=' + s.purchaseID + '?';
                        document.body.appendChild(dclkFrame2);

                        if (s.purchaseID.indexOf("NL") != -1 && s.prop32 == "cc_nl") {
                            dclkFrame3.src = 'https://fls.doubleclick.net/activityi;src=4167672;type=cc_store;cat=mstore1' + ';qty=' + scProd[2] + ';cost=' + scProd[3] + ';u6=' + scSKUName + ';u5=' + s.currencyCode + ';u1=1;u2=' + scProdName + ';u7=' + s.countryCode + ';u20=250713;ord=' + s.purchaseID + '?';
                            setTimeout(function() {
                                document.body.appendChild(dclkFrame3);
                            }, 100);
                        }
                    }

                    if (typeof(s.countryCode) == "undefined") {
                        dclkFrame.src = 'https://fls.doubleclick.net/activityi;src=4167672;type=cc_store;cat=' + scSubCat + ';qty=' + scProd[2] + ';cost=' + scProd[3] + ';u6=' + scSKUName + ';u5=' + s.currencyCode + ';u1=1;u2=' + scProdName + ';u7=' + ((Adobe && Adobe.CheckoutAnyware && Adobe.CheckoutAnyware.ConfigModel && Adobe.CheckoutAnyware.ConfigModel.country) ? Adobe.CheckoutAnyware.ConfigModel.country : '') + ';u20=250713;ord=' + s.purchaseID + '?';
                        document.body.appendChild(dclkFrame);
                        ...
                        if (s.purchaseID.indexOf("NL") != -1 && s.prop32 == "cc_nl") {
                            dclkFrame3.src = 'https://fls.doubleclick.net/activityi;src=4167672;type=cc_store;cat=mstore1' + ';qty=' + scProd[2] + ';cost=' + scProd[3] + ';u6=' + scSKUName + ';u5=' + s.currencyCode + ';u1=1;u2=' + scProdName + ';u7=' + ((Adobe && Adobe.CheckoutAnyware && Adobe.CheckoutAnyware.ConfigModel && Adobe.CheckoutAnyware.ConfigModel.country) ? Adobe.CheckoutAnyware.ConfigModel.country : '') + ';u20=250713;ord=' + s.purchaseID + '?';
                            setTimeout(function() {
                                document.body.appendChild(dclkFrame3);
                            }, 100);
                        }
                    }
                } else if (scSubCat == 'educa938') {
                    dclkFrame.src = 'https://2685741.fls.doubleclick.net/activityi;src=2685741;type=educa754;cat=' + scSubCat + ';qty=' + scProd[2] + ';cost=' + scProd[3] + ';u7=' + scSKUName + ';u6=' + s.currencyCode + ';u1=1;u2=' + scProdName + ';ord=' + s.purchaseID + '?';
                    document.body.appendChild(dclkFrame);
					if(s.purchaseID.indexOf("AU") != -1){
					dclkFrame2.src = 'https://1295336.fls.doubleclick.net/activityi;src=1295336;type=store031;cat=austr0' + ';qty=' + scProd[2] + ';cost=' + scProd[3] + ';u7=' + scSKUName + ';u6=' + s.currencyCode + ';u1=1;u2=' + scProdName + ';ord=' + s.purchaseID + '?';
                    document.body.appendChild(dclkFrame2);
					}
					if(s.purchaseID.indexOf("NZ") != -1){
					dclkFrame2.src = 'https://1295336.fls.doubleclick.net/activityi;src=1295336;type=store031;cat=newze0' + ';qty=' + scProd[2] + ';cost=' + scProd[3] + ';u7=' + scSKUName + ';u6=' + s.currencyCode + ';u1=1;u2=' + scProdName + ';ord=' + s.purchaseID + '?';
                    document.body.appendChild(dclkFrame2);
					}	

                } else if (scSubCat == 'ccmteam') {
                    if (typeof(s.countryCode) !== "undefined") {
                        dclkFrame.src = 'https://fls.doubleclick.net/activityi;src=4167672;type=cc_store;cat=' + scSubCat + ';qty=' + scProd[2] + ';cost=' + scProd[3] + ';u6=' + scSKUName + ';u5=' + s.currencyCode + ';u1=1;u2=' + scProdName + ';u7=' + s.countryCode + ';ord=' + s.purchaseID + '?';
                        document.body.appendChild(dclkFrame);

                        dclkFrame2.src = 'https://1295336.fls.doubleclick.net/activityi;src=1295336;type=store031;cat=adobe544' + ';qty=' + scProd[2] + ';cost=' + scProd[3] + ';u7=' + scSKUName + ';u6=' + s.currencyCode + ';u1=1;u2=' + scProdName + ';ord=' + s.purchaseID + '?';
                        document.body.appendChild(dclkFrame2);
                    }

                    if (typeof(s.countryCode) == "undefined") {
                        dclkFrame.src = 'https://fls.doubleclick.net/activityi;src=4167672;type=cc_store;cat=' + scSubCat + ';qty=' + scProd[2] + ';cost=' + scProd[3] + ';u6=' + scSKUName + ';u5=' + s.currencyCode + ';u1=1;u2=' + scProdName + ';u7=' + ((Adobe && Adobe.CheckoutAnyware && Adobe.CheckoutAnyware.ConfigModel && Adobe.CheckoutAnyware.ConfigModel.country) ? Adobe.CheckoutAnyware.ConfigModel.country : '') + ';ord=' + s.purchaseID + '?';
                        document.body.appendChild(dclkFrame);
                    ...
                    if (typeof(s.countryCode) !== "undefined") {
                        dclkFrame.src = 'https://fls.doubleclick.net/activityi;src=4167672;type=edustore;cat=' + scSubCat + ';qty=' + scProd[2] + ';cost=' + scProd[3] + ';u6=' + scSKUName + ';u5=' + s.currencyCode + ';u1=1;u2=' + scProdName + ';u7=' + s.countryCode + ';u20=250713;ord=' + s.purchaseID + '?';
                        document.body.appendChild(dclkFrame);

                        dclkFrame2.src = 'https://1295336.fls.doubleclick.net/activityi;src=1295336;type=store031;cat=adobe398' + ';qty=' + scProd[2] + ';cost=' + scProd[3] + ';u7=' + scSKUName + ';u6=' + s.currencyCode + ';u1=1;u2=' + scProdName + ';ord=' + s.purchaseID + '?';
                        document.body.appendChild(dclkFrame2);

                        if (s.purchaseID.indexOf("NL") != -1 && s.prop32 == "cc_nl") {
                            dclkFrame3.src = 'https://fls.doubleclick.net/activityi;src=4167672;type=edustore;cat=mstore2' + ';qty=' + scProd[2] + ';cost=' + scProd[3] + ';u6=' + scSKUName + ';u5=' + s.currencyCode + ';u1=1;u2=' + scProdName + ';u7=' + s.countryCode + ';u20=250713;ord=' + s.purchaseID + '?';
                            setTimeout(function() {
                                document.body.appendChild(dclkFrame3);
                            }, 100);
                        }
                    ...
                    if (typeof(s.countryCode) == "undefined") {
                        dclkFrame.src = 'https://fls.doubleclick.net/activityi;src=4167672;type=edustore;cat=' + scSubCat + ';qty=' + scProd[2] + ';cost=' + scProd[3] + ';u6=' + scSKUName + ';u5=' + s.currencyCode + ';u1=1;u2=' + scProdName + ';u7=' + ((Adobe && Adobe.CheckoutAnyware && Adobe.CheckoutAnyware.ConfigModel && Adobe.CheckoutAnyware.ConfigModel.country) ? Adobe.CheckoutAnyware.ConfigModel.country : '') + ';u20=250713;ord=' + s.purchaseID + '?';
                        document.body.appendChild(dclkFrame);
                        ...
                        if (s.purchaseID.indexOf("NL") != -1 && s.prop32 == "cc_nl") {
                            dclkFrame3.src = 'https://fls.doubleclick.net/activityi;src=4167672;type=edustore;cat=mstore2' + ';qty=' + scProd[2] + ';cost=' + scProd[3] + ';u6=' + scSKUName + ';u5=' + s.currencyCode + ';u1=1;u2=' + scProdName + ';u7=' + ((Adobe && Adobe.CheckoutAnyware && Adobe.CheckoutAnyware.ConfigModel && Adobe.CheckoutAnyware.ConfigModel.country) ? Adobe.CheckoutAnyware.ConfigModel.country : '') + ';u20=250713;ord=' + s.purchaseID + '?';
                            setTimeout(function() {
                                document.body.appendChild(dclkFrame3);
                            }, 100);
                        }
                ...
                if (typeof(s.countryCode) !== "undefined") {
                    mboxDefine('tntOrderConfirm', 'cc-orderConfirmPage-mbox', 'country=' + s.countryCode, 'cc=' + s.currencyCode, 'productPurchasedId=' + scProdName, 'orderTotal=' + scProd[3], 'orderId=' + s.purchaseID);
                    mboxUpdate('cc-orderConfirmPage-mbox', 'country=' + s.countryCode, 'cc=' + s.currencyCode, 'productPurchasedId=' + scProdName, 'orderTotal=' + scProd[3], 'orderId=' + s.purchaseID);
                }
                if (typeof(s.countryCode) == "undefined") {
                    mboxDefine('tntOrderConfirm', 'cc-orderConfirmPage-mbox', 'country=' + ((Adobe && Adobe.CheckoutAnyware && Adobe.CheckoutAnyware.ConfigModel && Adobe.CheckoutAnyware.ConfigModel.country) ? Adobe.CheckoutAnyware.ConfigModel.country : ''), 'cc=' + s.currencyCode, 'productPurchasedId=' + scProdName, 'orderTotal=' + scProd[3], 'orderId=' + s.purchaseID);
                    mboxUpdate('cc-orderConfirmPage-mbox', 'country=' + ((Adobe && Adobe.CheckoutAnyware && Adobe.CheckoutAnyware.ConfigModel && Adobe.CheckoutAnyware.ConfigModel.country) ? Adobe.CheckoutAnyware.ConfigModel.country : ''), 'cc=' + s.currencyCode, 'productPurchasedId=' + scProdName, 'orderTotal=' + scProd[3], 'orderId=' + s.purchaseID);
                }
            }
        }

        if (!s.pageName && document.referrer != '' && (document.URL == 'https://creative.adobe.com/' || document.URL.indexOf('/apps#') != -1 || document.URL.indexOf('/files/#') != -1 || document.URL.indexOf('/products') != -1)) {
