...
adobe.dom.GNav = function()
{
	...
	gnav = {
		...
		Version: 'v1.1.4',
		CDN: 'https://wwwimages2.adobe.com',
	...
	if(gnav.ImsHost.indexOf('stage') > -1 || gnav.ImsHost.indexOf('.wa.') > -1 || gnav.ImsHost.indexOf('helpx.qa') > -1 || gnav.ImsHost.indexOf('localhost.adobe') > -1 || gnav.ImsHost.indexOf('aceui.') > -1 || gnav.ImsHost.indexOf('con-a.') > -1)
	{
